<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReviewFormList.aspx.cs" Inherits="ReviewFormList" %>
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header">
                    <h2>
                        <i class="halflings-icon align-justify"></i><span class="break"></span>Review Form</h2>
                    <div class="box-icon">
                ...
                <asp:GridView ID="GridView1" CssClass="table table-striped" runat="server" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>                           
                                <a href='<%# "ReviewForm.aspx?RID=" + Eval("Emp_Form_Id")%>'>REVIEW</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
